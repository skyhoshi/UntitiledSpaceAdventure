...
public class WeaponSystem : MonoBehaviour
{
    ...
    private void ProcessBullets()
    {
        ...
        for (var i = 0; i < bulletCount; i++)
        {
            ...
            var bulletComponent = (AdvancedBullet)bullet.GetComponent(typeof(AdvancedBullet));
            ...
            if (mirrorX)
            {
                ...
                var bulletMirroredComponent = (AdvancedBullet)bulletMirrored.GetComponent(typeof(AdvancedBullet));
