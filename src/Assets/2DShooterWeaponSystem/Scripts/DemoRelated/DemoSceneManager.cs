...
public class DemoSceneManager : MonoBehaviour
{
    ...
    public AdvancedPlayerMovement playerMovementRef;
    ...
    private void SetShooterPresetTypeHorizontal()
    {
        ...
        playerMovementRef.playerMovementType = AdvancedPlayerMovement.PlayerMovementType.Normal;
    }
    ...
    private void SetShooterPresetTypeFreeAim()
    {
        ...
        playerMovementRef.playerMovementType = AdvancedPlayerMovement.PlayerMovementType.FreeAim;
    }
